...
namespace Unigram.Common
{
    public class ApplicationSettings
    {
        ...
        public bool IsConfirmEnabled
        {
            get
            {
                if (_isConfirmEnabled == null)
                    _isConfirmEnabled = GetValueOrDefault("IsConfirmEnabled", true);

                return _isConfirmEnabled ?? true;
            }
            set
            {
                _isConfirmEnabled = value;
                AddOrUpdateValue("IsConfirmEnabled", value);
            }
        }
